...
import socketserver, os, atexit, pickle
import wrapper
...
# load_pickle: read pickle object from a file
# returns pickle object encoded by a file
RPCServerHandler.register_function(lambda d : load_pickle_file( d['path'] ), 'load_pickle')
